...
class ZhipuAdapter:
    ...
    async def list_models(self) -> list[dict]:
        """列出可用模型"""
        return [
            {"name": "glm-4-flash", "description": "GLM-4 Flash"},
            {"name": "glm-4", "description": "GLM-4"},
            {"name": "glm-4-plus", "description": "GLM-4 Plus"},
            {"name": "glm-3-turbo", "description": "GLM-3 Turbo"}
        ]
